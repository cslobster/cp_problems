/*
 * store segment trees for both a and b, for smallest neg, biggest neg, smallest pos, biggest pos
 * casework on these options for a, see what is most optimal for b
 * one with biggest product is what a will choose (most optimal for a) so it is the answer
 *
 * debugging note: don't change the segment tree size (don't add one), it messes the whole thing up
 */
